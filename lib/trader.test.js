...
function cfg() {
  return {
    ...
    trader: {
      ...
      postSum: 0.98, completeMaxSum: 0.99, leashSec: 15, requoteMs: 1000,
      makerCooldownSec: 60, makerBandMin: 0.01, makerBandMax: 0.99, makerMaxMove: 1, makerMoveWindowSec: 10, makerStop: 0.05,
